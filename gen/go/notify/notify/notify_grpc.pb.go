...
const (
	NotifyService_Send_FullMethodName = "/notify.v2.NotifyService/Send"
)
...
type NotifyServiceClient interface {
	Send(ctx context.Context, in *NotifyRequest, opts ...grpc.CallOption) (*NotifyResponse, error)
}
...
func (c *notifyServiceClient) Send(ctx context.Context, in *NotifyRequest, opts ...grpc.CallOption) (*NotifyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NotifyResponse)
	err := c.cc.Invoke(ctx, NotifyService_Send_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotifyServiceServer interface {
	Send(context.Context, *NotifyRequest) (*NotifyResponse, error)
...
func (UnimplementedNotifyServiceServer) Send(context.Context, *NotifyRequest) (*NotifyResponse, error) {
...
func _NotifyService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotifyService_Send_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotifyServiceServer).Send(ctx, req.(*NotifyRequest))
	}
...
var NotifyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "notify.v2.NotifyService",
